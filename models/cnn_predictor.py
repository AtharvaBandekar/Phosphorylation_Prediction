...
class PhosphoPredictorCNN(nn.Module):
    def __init__(self, num_amino_acids, sequence_length, kernel_size=5):
        ...
        self.conv1 = nn.Conv1d(in_channels=num_amino_acids, out_channels=32, kernel_size=kernel_size, padding='same')
        self.relu1 = nn.ReLU()
        self.pool1 = nn.MaxPool1d(kernel_size=2, stride=2)
        self.dropout1 = nn.Dropout(0.25)

        self.conv2 = nn.Conv1d(in_channels=32, out_channels=64, kernel_size=kernel_size, padding='same')
        self.relu2 = nn.ReLU()
        ...
        self.flattened_size = 64 * l_after_pool2 
